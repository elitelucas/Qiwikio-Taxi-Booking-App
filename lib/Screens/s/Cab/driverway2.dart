...
class DriverWay2 extends StatefulWidget {
  static String id = "driverway2";

  final LocationData location;

  DriverWay2({this.location});

  @override
  _DriverWay2State createState() => _DriverWay2State();
}

class _DriverWay2State extends State<DriverWay2> {
