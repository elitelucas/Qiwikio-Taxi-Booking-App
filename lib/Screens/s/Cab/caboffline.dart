...
class CabOffline extends StatefulWidget {
  static String id = "caboffline";

  final LocationData location;

  CabOffline({this.location});

  @override
  _CabOfflineState createState() => _CabOfflineState();
}

class _CabOfflineState extends State<CabOffline> {
