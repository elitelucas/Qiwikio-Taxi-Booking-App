...
import 'package:qwikio_driver/Screens/s/Profile/earninghistory2.dart';

class EarningHistory3 extends StatefulWidget {
  const  EarningHistory3({Key key}) : super(key: key);

  @override
  _EarningHistory3State createState() => _EarningHistory3State();
}

class _EarningHistory3State extends State< EarningHistory3> {
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder:(context)=> EarningHistory2()));
                    },
                    child: Container(
                      width: 100,
                      height: 50,
                      ...
                      child: Center(child: Text('Week',style: Textt1.textStyle(kPrimaryfont, 15.0),),),
                    ),
                  ),
                  Container(
                    width: 100,
                    ...
                    child: Center(child: Text('Month',style: Textt1.textStyle(Colors.white, 15.0),),),
                  ),
