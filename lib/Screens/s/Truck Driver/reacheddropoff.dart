...
import 'package:qwikio_driver/Screens/s/Truck Driver/arrived.dart';


class ReachedDropff extends StatefulWidget {
  static String id = "reacheddropoff";

  final LocationData location;

  ReachedDropff({this.location});

  @override
  _ReachedDropffState createState() => _ReachedDropffState();
}

class _ReachedDropffState extends State< ReachedDropff > {
        ...
        child: Padding(
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              Text('Pickup location',style: Textt2.textStyle(kPrimaryfont, 15.0),),
              SizedBox(
                height: 10.0,
              ),
              Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Icon(FontAwesome.location,color: Colors.red,),
                            ),
              ...
              AuthButton(colorr: kPrimarycolor,
                textt: 'Start Navigation',
                textStyle: Textt1.textStyle(Colors.white, 15.0),
                onchanged: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> Arrived()));
                },
              ),
            ],
          ),
