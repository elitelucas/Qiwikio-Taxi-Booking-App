...
class BikeSignup extends StatefulWidget {
  static String id = "bikesignup";

  const BikeSignup({Key key}) : super(key: key);

  @override
  _BikeSignupState createState() => _BikeSignupState();
}

class _BikeSignupState extends State<BikeSignup> {
