...
class TruckPickup2 extends StatefulWidget {
  static String id = "truckpickup2";

  final LocationData location;

  TruckPickup2({this.location});

  @override
  _TruckPickup2State createState() => _TruckPickup2State();
}

class _TruckPickup2State extends State< TruckPickup2> {
