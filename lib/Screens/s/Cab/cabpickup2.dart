...
class CabPickup2 extends StatefulWidget {
  static String id = "cabpickup2";

  final LocationData location;

  CabPickup2({this.location});

  @override
  _CabPickup2State createState() => _CabPickup2State();
}

class _CabPickup2State extends State<CabPickup2> {
