...
import 'package:qwikio_driver/Screens/s/Truck Driver/truckdriverway.dart';



class ReachedPickup extends StatefulWidget {
  static String id = "reachedpickup";

  final LocationData location;

  ReachedPickup({this.location});
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              AuthButton(colorr: kPrimarycolor,
                ...
                onchanged: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> TruckDriverWay()));
                },
              ),
            ],
          ),
