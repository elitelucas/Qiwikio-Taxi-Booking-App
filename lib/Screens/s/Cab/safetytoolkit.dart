...
class SafetyToolkit extends StatefulWidget {
  static String id = "safetytoolkit";

  final LocationData location;
SafetyToolkit({this.location});

  @override
  _SafetyToolkitState createState() => _SafetyToolkitState();
}
          ...
          return AlertDialog(
            ...
            title: Stack(
              children: [
                Container(
                  height: 150,
                  child: Image.asset('assets/images/congo.png',fit: BoxFit.fill,),
                ),
                Positioned(
                    right: 2.0,
                  ...
                  children: [
                    ...
                    RaisedButton(onPressed: (){
                      ...
                      child:SizedBox(
                        width: 265,
                        height: 55,
                        child: Center(child: Text('Got It',style: Textt1.textStyle(Colors.white, 15),textAlign: TextAlign.center,)),
                      ),
                      shape: RoundedRectangleBorder(
