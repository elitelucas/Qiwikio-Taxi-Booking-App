...
import 'package:qwikio_driver/Screens/s/Truck Driver/reacheddropoff.dart';



class TruckDriverWay extends StatefulWidget {
  static String id = "truckdriverway";

  final LocationData location;

  TruckDriverWay({this.location});

  @override
  _TruckDriverWayState createState() => _TruckDriverWayState();
}

class _TruckDriverWayState extends State< TruckDriverWay > {
          ...
          child: ListView(
            ...
            children: <Widget>[
              ...
              AuthButton(colorr: kPrimarycolor,
                ...
                onchanged: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> ReachedDropff()));
                },
              ),
            ],
          ),
