...
class  TruckPickup3 extends StatefulWidget {
  static String id = "truckpickup3";

  final LocationData location;

  TruckPickup3({this.location});

  @override
  _TruckPickup3State createState() => _TruckPickup3State();
}

class _TruckPickup3State extends State< TruckPickup3> {
