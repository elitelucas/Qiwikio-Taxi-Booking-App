...
class TruckSignup extends StatefulWidget {
  static String id = "trucksignup";

  const TruckSignup({Key key}) : super(key: key);

  @override
  _TruckSignupState createState() => _TruckSignupState();
}

class _TruckSignupState extends State<TruckSignup> {
        ...
        child: Center(
          child: Column(
            children: [
              ...
              AuthButton(
                onchanged: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context)=> LoadVerify()),);
                },
                textt: 'Next',
